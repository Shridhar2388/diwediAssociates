                        ...
                        <div className="col-12">
                            <Card className="shadow-sm" style={{ backgroundColor: 'whitesmoke' }}>
                                <Card.Body>
                                    ...
                                    <h4 style={{ color: "#3b83b7" }}>Company Profile</h4>
                                    <p style={{ textAlign: "justify", textJustify: "inter-word" }}>
                                        <strong>Dwivedi Associates & Solicitors</strong> firm have a perfect blend of experienced and young lawyers who caters to the need of clients from all walks of life ranging from Corporate to Firm to Individual clients. Firm adopt cost and time effective techniques to get the best result. Our client centric approach ensures complete satisfaction to the client's legal problem. Our Firm adopts innovative measures using technology at its best to effectively present the case in all Courts and all concerning authorities. Our Firm undertakes drafting and registration of all types of Legal Documents.
                                    </p>

                                    <h4 style={{ color: "#3b83b7" }}>Our Clients</h4>
                                    <Row>
                                        <Col>
                                            <ul>
